    ...
    (function(factory) {
        ...
        EmailBuilder.prototype = {
            defaults: {
                ...
                onClickSaveAndExitButton: function(e) {},
            ...
            generate: function(elementsHtml) {
                ...
                if (_this.config.showSettingsLoadTemplate == true) {
                    _nav += '<li class="bal-menu-item load-templates">' +
                        '<i class="fa fa-file-text"></i>' +
                        '<span class="bal-menu-name">' + _this.langArr.settingsLoadTemplate + '</span>' +
                        '</li>';
                }
            ...
            events_of_setting: function() {
                ...
                _this.$elem.on('click', '.bal-menu-item.load-templates', function(event) {
                ...
                //Save and exit html
                $(document).on('click', '#bal-button-save-and-exit', function(event) {
                    _getHtml = _this.getContentHtml();
                    if (_this.config.onClickSaveAndExitButton !== undefined) {
                        _this.config.onClickSaveAndExitButton(event, _getHtml);
                    }
                    //if user want stop this action : e.preventDefault();
                    if (event.isDefaultPrevented() == true) {
                        return false;
                ...
                //Save html
                $(document).on('click', '#bal-button-save-template', function(event) {
                    _getHtml = _this.getContentHtml();
                    if (_this.config.onClickSaveTemplateButton !== undefined) {
                        _this.config.onClickSaveTemplateButton(event, _getHtml);
                    }
                    //if user want stop this action : e.preventDefault();
                    if (event.isDefaultPrevented() == true) {
                        return false;
                ...
                $(document).on('click', '#bal-button-save-remain', function(event) {
                    _getHtml = _this.getContentHtml();
                    if (_this.config.onClickSaveButton !== undefined) {
                        _this.config.onClickSaveButton(event, _getHtml);
                    }
                    //if user want stop this action : e.preventDefault();
                    if (event.isDefaultPrevented() == true) {
                        return false;
                ...
                //exit html
                $(document).on('click', '#bal-button-exit', function(event) {
                    if (_this.config.onClickExitButton !== undefined) {
                        _this.config.onClickExitButton(event);
                    }
                    //if user want stop this action : e.preventDefault();
                    if (event.isDefaultPrevented() == true) {
                        return false;
