...
use App\Http\Controllers\MobileDetectController;
...
class DetectController extends Controller {
	...
	public static function init() {
		self::$detect = new MobileDetectController();
		self::$detect->setDetectionType(MobileDetectController::DETECTION_TYPE_EXTENDED);
		self::getIp();
	}

	private static function getIp() {
		#self::$setDetectionType(MobileDetectController::DETECTION_TYPE_EXTENDED);
