...
@section('title', 'Sendmunk | Edit SMS/MMS Campaign')
        ...
        <form class="ui form" id="sms_campaign_form" action="{{ url('updatesmscampaign') }}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="field">
                ...
                <select class="ui dropdown" name="integration" required>
                    ...
                    <option value="{{ $integration->id }}" {{ $integration->id == $sms_campaign->sms_mms_integration_id ? "selected" : "" }}>{{ $integration->twilio_number }} (Twilio Number)</option>
                    @endforeach
                </select>
            </div>
            <div class="ui segment">
            ...
            <div class="field">
                ...
                <p class="emoji-picker-container">
                    <textarea data-emojiable="true" data-emoji-input="unicode" name="content" placeholder="Enter Message Body" rows="5">{{ $sms_campaign->content }}</textarea>
                </p>
            </div>
            <div>
