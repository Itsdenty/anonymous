...
@section('title', 'Sendmunk | Create Theme')
                    ...
                    <div class="ui styled accordion">
                        ...
                        <div class="content">
                            ...
                            <div class="inline fields">
                                ...
                                <div class="ui right labeled input">
                                    <input id="border_size" name="border_size" type="number" value="3"/>
                        ...
                        <div class="content">
                            <div class="inline fields">
                                ...
                                <div class="field">
                                    <div class="ui right labeled input">
                                        <input id="button_font_size" name="button_font_size" type="number" value="14" />
                                        <div class="ui basic label">px</div>
                                    </div>
                                </div>
                            </div>
