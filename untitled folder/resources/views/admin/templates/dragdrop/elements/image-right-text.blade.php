                    ...
                    <tr>
                        <td class="element-content"   contenteditable="true"
                            ...
                            {{-- <img border="0" align="right" class="content-image "
                                 ...
                                 style="display: block;margin: 0px;padding:0 0 0 10px;width:350px;height:150px"> --}}
                                 <img border="0" align="right" class="content-image " src="https://via.placeholder.com/350x150?text=350%C3%97150" style="display: block;margin: 0px;padding:0 0 0 10px;width:350px;height:150px">
