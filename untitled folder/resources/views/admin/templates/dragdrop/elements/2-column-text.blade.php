<table class="main" cellspacing="0" cellpadding="0" border="0" data-types="background,border-radius,padding,image-settings" data-last-type="background" style="background-color:#FFFFFF" align="center">
    <tbody>
        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td contenteditable="true" align="center" class="element-contenteditable active">
                                ...
                                {{-- <img border="0" class="content-image " src="https://placeholdit.imgix.net/~text?txtsize=33&amp;txt=250%C3%97150&amp;w=240&amp;h=150" style="display: inline-block;margin: 0px;width:240px;height:150px"> --}}
                                <img border="0" class="content-image" src="https://via.placeholder.com/240x150?text=250%C3%97150" style="display: inline-block;margin: 0px;width:240px;height:150px">
