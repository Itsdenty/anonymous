...
<html>
    <head>
        <title>Sendmunk: Drag and Drop</title>
    ...
    <body>
        <div class="bal-header">
            <div class="bal-user-info">
                <div class="bal-header-controls">
                    <a id="bal-button-save-remain" class="bal-button-exit" href="#">Save</a>
                    <a id="bal-button-save-and-exit" class="bal-button-exit" href="#">Save & Exit</a>
        ...
        <script>
            ...
            var  _emailBuilder=  $('.bal-editor-demo').emailBuilder({
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            setTimeout(() => {
                                ...
                                window.location.href = sessionStorage.getItem("Sendmunk_drapdrop_redirect");
                ...
                onClickSaveButton: function(e, getHtml){
                    $.ajax({
                        url: 'save_template',
                        headers: {'X-CSRF-Token': '{{ csrf_token() }}'},
                        type: 'POST',
                ...
                onClickExitButton: function(e){
                    window.location.href = sessionStorage.getItem("Sendmunk_drapdrop_redirect");
                    sessionStorage.setItem("Sendmunk_drapdrop_activetab", '#content_tab');
                }
            });
            ...
            $(document).ready(function(){
                var check_content = <?PHP echo json_encode($campaign->editable_content); ?>;
                if(check_content)
                {
                    setTimeout(function(){
                        $('.bal-content-wrapper').html('{!! str_replace(array("\n", "\r"), '', $campaign->editable_content) !!}');
                    }, 1000);
                }
