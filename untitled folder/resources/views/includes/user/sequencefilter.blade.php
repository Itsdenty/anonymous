<div class="filterable">
    <div>
        ...
        <div style="display:flex; justify-content: space-between; margin-bottom: 10px;">
            <div><h3>This Sequence will have: </h3></div>  
        </div>
    </div>

    <div>
        <a id="filter_form_button" href="#" class="ui primary button" style="margin-bottom: 10px;">
        <i class=""></i>Filter Subscribers</a>
    </div>
    <div id="create_form_modal_5" class="ui tiny modal">
        <div class="header">Filter Sequence Subscribers</div>
        <div class="content">
            <div class="ui form">
            ...
            <table class="ui table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $contact->name }}</td>
                        <td>{{ $contact->email }}</td>
                        <td style="text-align: center"><a class="remove_contact" href="{{ url('remove_contact/'.$contact->id.'/sequence'.'/'.$sequence->id) }}"><i class="delete icon"></i></a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            @else
            <div class="ui message">You have not contacts for this sequence</div>
            @endif
        </div>
    </div>
