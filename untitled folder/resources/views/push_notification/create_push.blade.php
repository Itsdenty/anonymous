...
@section('title', 'Sendmunk | Create Push Popup')

@section('content')
    <div class="ui vertical segment">
        <h2>Create Push Popup</h2>    
    </div>
    <br/>
            ...
            <form id="update_form" action="{{ url('updateform') }}" class="ui form" method="post" role="form">
                ...
                <div class="ui tab" data-tab="message">
                    ...
                    <div class="field" data-control="summernote-container">
                        ...
                        <textarea class="summernote" name="headline" id="headline_input">Push Notification</textarea>
                    </div>
                    
                    <div class="field" data-control="summernote-container">
                        <label>Description</label>
                        <textarea class="summernote" name="description" id="description_input">Subscribe here to receive our push notifications</textarea>
                    </div>

                    <div class="field">
                        <label>Button Text</label>
                        <input name="button_text" id="start_action_button_input" type="text" value="Subscribe" />
                    </div>
