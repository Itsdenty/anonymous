...
@section('title', 'Sendmunk | Create Quiz')
...
@section('content')
    ...
    <div id="form_navbar" class="ui pointing secondary stackable menu">
        ...
        <div class="item">
            <button type="submit" form="update_form" class="publish ui primary button">Publish Quiz</button>
        </div>
    </div>
    <br/>
            ...
            <form id="update_form" action="{{ url('updateform') }}" class="ui form" method="post" role="form">
                ...
                <div class="ui tab" data-tab="message">
                    ...
                    <div class="field" data-control="summernote-container">
                        <label>Heading</label>
                        <textarea class="summernote" name="headline" id="headline_input">QUIZ HEADING GOES HERE</textarea>
                    </div>
                    <div class="field" data-control="summernote-container">
                        <label>Subheading</label>
                        <textarea class="summernote" name="description" id="description_input">Quiz Subheading goes here</textarea>
                    </div>
                    <div class="field">
