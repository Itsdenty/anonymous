            ...
            <form id="update_form" action="{{ url('updateform') }}" class="ui form" method="post" role="form">
                ...
                <div class="ui tab" data-tab="message">
                    ...
                    <div class="field" data-control="summernote-container">
                        ...
                        <textarea class="summernote" name="headline" id="headline_input"></textarea>
                    </div>
                    @if($form->form_type == 'scrollbox' || $form->form_type == 'popover' || $form->form_type == 'embedded' || $form->form_type == 'welcome_mat')
                    <div class="field" data-control="summernote-container">
                        <label>Description</label>
                        <textarea class="summernote" name="description" id="description_input"></textarea>
                    </div>
                    <div class="field" data-control="summernote-container">
                        <label>Foot Note</label>
                        <textarea class="summernote" name="foot_note" id="footnote_input"></textarea>
                    </div>
                    @endif
                    <h4>Thank You Message</h4>
                    <div class="field" data-control="summernote-container">
                        <label>Success Screen Headline</label>
                        <textarea class="summernote" id="success_headline_input" name="success_headline"></textarea>
                    </div>
                    @if($form->form_type == 'scrollbox' || $form->form_type == 'popover' || $form->form_type == 'embedded' || $form->form_type == 'welcome_mat')
                    <div class="field" data-control="summernote-container">
                ...
                <div class="ui tab" data-tab="appearance">
                    <div class="ui styled accordion">
                        ...
                        <div class="active content appearance">
                            ...
                            <div class="two fields">
                                <div class="field">
                                    ...
                                    @if($form->form_type == 'scrollbox' || $form->form_type == 'popover' || $form->form_type == 'embedded' || $form->form_type == 'welcome_mat')
                                    <input name="button_color" id="bg_color_button" type="color" value="{{ $form->button_color }}" />
                                    @endif
                                    @if($form->form_type == 'topbar')
                                    <input name="button_color" id="bg_color_button" type="color" value="{{ $form->button_color }}" />
                                    @endif
                                ...
                                <div class="field">
                                    <label>Text</label>
                                    <input name="button_text_color" id="bg_color_text" type="color" value="{{ $form->button_text_color }}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="content">
                            ...
                            <input type="radio" name="position" id="left" value="left" {{ ($form->position == "left") ? "checked" : "" }} />
                            <label for="left">Left</label>
                            &nbsp;&nbsp;&nbsp;
                            <input type="radio" name="position" id="right" value="right" {{ ($form->position == "right") ? "checked" : "" }} />
                            <label for="right">Right</label>
                            @endif
                            @if($form->form_type == 'topbar')
                            <input type="radio" name="position" id="top" value="top" {{ ($form->position == "top") ? "checked" : "" }} />
                            <label for="top">Top of Page</label>
                            &nbsp;&nbsp;&nbsp;
                            <input type="radio" name="position" id="bottom" value="bottom" {{ ($form->position == "bottom") ? "checked" : "" }} />
                ...
                <div class="ui tab" data-tab="fields">
                    ...
                    <h4>Form Fields</h4>
                    <div class="ui styled accordion appearance">
                    ...
                    <h4>Button Text</h4>
                    <div class="field">
                        <input name="button_text" id="submit_button_input" type="text" value="{{ $form->button_text }}" />
                    </div>
                </div>
                <div class="ui tab" data-tab="behavior">
                    <div class="ui styled accordion">
                        ...
                        <div class="active content appearance">
                            ...
                            <div class="field">
                                <div class="ui right labeled input">
                                    <input name="trigger_point" type="number" min="0" max="100" value="{{ $form->trigger_point }}" />
                            ...
                            <div class="field">
                                <div class="ui right labeled input">
                                    <input name="hide_duration" type="number" min="0" value="{{ $form->hide_duration }}" />
                                    <div class="ui basic label">days</div>
                                </div>
                            </div>
                            <h4>AUTO HIDE</h4>
                            <div class="ui toggle checkbox">
                                <input type="checkbox" name="autohide" {{ ($form->autohide) ? "checked" : "" }}>
                        ...
                        <div class="active content appearance">
                            <h4>ALLOW CLOSING</h4>
                            <div class="ui toggle checkbox">
                                <input id="allow_closing" type="checkbox" name="allow_closing" {{ ($form->allow_closing) ? "checked" : "" }} />
...
@section('footerscripts')
    <script>
        ...
        $(function() {
            ...
            $('#submit_button').css('background', $('#bg_color_button').val());
            $('#submit_button').css('color', $('#bg_color_text').val());
            $('#email').attr('placeholder', $('#email_input').val());
            $('#form_preview, #success_preview').css('border-width', $('#border_size').val()  + 'px');
            $('#form_preview, #success_preview').css('border-color', $('#border_color').val());
        ...
        $('#bg_color_button').bind('input', function(){
            $('#submit_button').css('background', $('#bg_color_button').val());
        });
        $('#bg_color_text').bind('input', function(){
            $('#submit_button').css('color', $('#bg_color_text').val());
        });
        ...
        $('#border_style').change(function(){
            $('#form_preview, #success_preview').css('border-style', $(this).val());
        });

        $("#border_size").bind('input', function(){
            $('#form_preview, #success_preview').css('border-width', $(this).val()  + 'px');
        });

        $("#border_color").bind('input', function(){
            $('#form_preview, #success_preview').css('border-color', $(this).val());
        });
