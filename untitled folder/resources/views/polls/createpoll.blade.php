...
@section('title', 'Sendmunk | Create Poll')
...
@section('content')
    ...
    <div id="form_navbar" class="ui pointing secondary stackable menu">
        ...
        <div class="item">
            <button type="submit" form="update_form" class="publish ui primary button">Publish Poll</button>
        </div>
    </div>
    <br/>
            ...
            <form id="update_form" action="{{ url('updateform') }}" class="ui form" method="post" role="form">
                ...
                <div class="ui tab" data-tab="message">
                    ...
                    <div class="field" data-control="summernote-container">
                        <label>Heading</label>
                        <textarea class="summernote" name="headline" id="headline_input">POLL HEADING GOES HERE</textarea>
                    </div>
                    <div class="field" data-control="summernote-container">
                        <label>Subheading</label>
                        <textarea class="summernote" name="description" id="description_input">Poll Subheading goes here</textarea>
                    </div>
                    <div class="field">
                    ...
                    <div class="field" data-control="summernote-container">
                        ...
                        <textarea class="summernote" id="success_headline_input" name="success_headline">Thank You</textarea>
                    </div>
                    <div class="field" data-control="summernote-container">
                        <label>Result Description</label>
                        <textarea class="summernote" id="success_description_input" name="success_description">Thanks for taking our poll.</textarea>
                    </div>
                </div>
                    ...
                    <div id="stored_questions">
                        @foreach($questions as $question)
                            <div class="ui tiny message question_div">
                                ...
                                <br/>
                                <a data-questionid="{{ $question->id }}" href="#" class="add_option"><i class="plus icon"></i>Add Options</a>
    ...
    <script>
        ...
        $(document).delegate('.save_question', 'click', function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    currentContainer.remove();
                    $('#stored_questions').append('<div class="ui tiny message question_div"><a  href="{{ url("delete/question")."/"}}'+ data['id'] +'" class="right floated ui icon button delete_question"><i class="delete icon"></i></a><div class="header">'+ data["title"] +  '</div><br/><a data-questionid="' + data['id']  + '" href="#" class="add_option"><i class="plus icon"></i>Add Options</a><ul class="stored_options"></ul><div class="new_options"></div></div>');
                },
                error: function(data){
                    console.log("An error occurred");
                }
