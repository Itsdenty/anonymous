<html lang="en">
      <head>
            ...
            <title>{{ $contact->unsubscribed ? 'Subscribe to' : 'Unsubscribe from'}} {{ $email->sequence->title }} - Sendmunk</title>
                    ...
                    <div class="three column row">
                        ...
                        <div class="column">
                            ...
                            <div class="ui segment" style="padding: 30px;">
                                <form class="ui form" method="post" action="{{ url('unsubscribe_contact_seq') }}" role="form">
                                    {{ csrf_field() }}
